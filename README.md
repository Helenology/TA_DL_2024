...
| **10月20日课程取消** |  |   |   |  |
| 第4次课 10月27日 | `qh` | `jx` | `bc` | `qh` `jx` `bc` |
| 第5次课 11月3日 | `jx` | `bc` | `qh` | `jx` `bc` `qh` |
| 第6次课 11月10日 | `bc` | `qh` | `jx` | `bc` `qh` `jx` |
| 第7次课 11月17日 | `qh` | `jx` | `bc` | `qh` `jx` `bc` |
| 第8次课 11月23日（周六18:30-22:00） | `jx` | `bc` | `qh` | `jx` `bc` `qh` |
